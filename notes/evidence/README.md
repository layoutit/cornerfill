...
Those statements describe this historical probe, not the repository's later
evidence. The production adapter and completed Firefox 1,213-leaf/820-tick ABBA
workload are indexed in [08 — Verification plan](../08-verification-plan.md);
native-to-candidate pixels remain `UNQUALIFIED` and released Safari remains open.
