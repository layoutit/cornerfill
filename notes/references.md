...
- [Complete Firefox Mario stress trace](evidence/firefox-mario-stress.md): eight fresh 820-tick workload-equivalent lanes with timing, paint, and teardown evidence; not native visual parity.
