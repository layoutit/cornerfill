...
- [CSSWG issue 14157 — broken half-corner/interpolation equations](https://github.com/w3c/csswg-drafts/issues/14157): open defect explaining why the printed equation and inverse do not agree with each other or implementations.
- [CSSWG issue 14158 — corner paths and overlapping shape components](https://github.com/w3c/csswg-drafts/issues/14158): open clarification around pre-clip paths and the boolean combination needed for general corners.
...
- [Hyperellipse README at pinned revision](https://github.com/mikhailmogilnikov/hyperellipse/blob/d530a4ec47f31c146b0af80a37c151d4f9f8cc5b/README.md): documents its `clip-path`/SVG fallback, which violates Cornerfill's rendering contract.
